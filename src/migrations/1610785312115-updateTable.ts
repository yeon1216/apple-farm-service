...
export class updateTable1610785312115 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "board" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "board" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
